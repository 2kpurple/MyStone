package org.purplek.hearthstone.support;
/*
...
public class PriorityList<E> extends AbstractList<E> implements Cloneable, Serializable, RandomAccess {
    ...
    @Override public boolean add(E object) {
        ...
        add(binarySearch(object), object);
        return true;
    }
    ...
    @Override public Object clone() {
        try {
            PriorityList<?> result = (PriorityList<?>) super.clone();
    ...
    private class ArrayListIterator implements Iterator<E> {
        ...
        @SuppressWarnings("unchecked") public E next() {
            PriorityList<E> ourList = PriorityList.this;
            int rem = remaining;
